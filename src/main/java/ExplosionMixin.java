...
/**
    ...
    private void init(ServerWorld serverWorld, Entity entity, DamageSource damageSource, ExplosionBehavior explosionBehavior, Vec3d vec3d, float f, boolean bl, Explosion.DestructionType destructionType, CallbackInfo ci) {
